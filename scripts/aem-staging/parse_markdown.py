...
try:
    ...
    # Optional: this script also runs offline, where the hand-rolled parser is used.
...
def parse_frontmatter_manually(fm_text: str) -> dict[str, Any]:
...
def normalize_categories(categories: object) -> str:
...
def parse_markdown(
    ...
    if not fork_repo_link:
        fork_repo_link = (
            f"https://github.com/Snowflake-Labs/sfquickstarts/tree/master/site/sfguides/src/{qid}"
        )
