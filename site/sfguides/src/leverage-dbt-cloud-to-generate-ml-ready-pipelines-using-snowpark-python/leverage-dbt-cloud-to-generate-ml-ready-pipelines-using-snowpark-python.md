...
1. [Sign up for a Snowflake Trial Account using this form](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_). Ensure that your account is set up using **AWS**. 
