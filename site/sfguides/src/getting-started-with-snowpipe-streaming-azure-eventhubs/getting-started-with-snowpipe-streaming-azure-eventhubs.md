...
- A [Snowflake Enterprise Account on Azure](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_) with `ACCOUNTADMIN` access
