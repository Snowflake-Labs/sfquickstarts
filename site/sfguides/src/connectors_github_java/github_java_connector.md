...
- Clone [example-github-java-connector repository](https://github.com/Snowflake-Labs/connectors-examples)
...
![configuration1.png](assets/configuration1.png =1674×1518)
