...
### What You’ll Need 
- A [Snowflake Enterprise Account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_) with `ACCOUNTADMIN` access in US WEST (OREGON REGION)
