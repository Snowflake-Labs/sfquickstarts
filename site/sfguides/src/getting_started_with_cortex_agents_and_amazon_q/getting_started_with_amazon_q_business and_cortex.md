...
In this use case you will build a Cortex Search service on the free text data from the script of the movie Toy Story and also build a Cortex Analyst semantic model on structured data related to movie ratings. You will then build a Cortex Agent specification and connect to it from Amazon Q for Business.

The end-to-end workflow will look like this:
![](assets/q-cortexarch.png)
