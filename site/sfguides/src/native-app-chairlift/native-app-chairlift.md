...
- A Snowflake account ([trial](https://signup.snowflake.com/developers?utm_source=snowflake-devrel&utm_medium=developer-guides), or otherwise). See note above on AWS as cloud provider for the deployment.
