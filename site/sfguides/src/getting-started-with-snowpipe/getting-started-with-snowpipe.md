...
### What You’ll Need 
- Create a [Snowflake account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&lab=getStartedWithSnowpipe&utm_cta=quickstart-getstartedwithsnowpipe-en&utm_cta=developer-guides) with an **ACCOUNTADMIN** role
