...
================================================================================
  ...
  -------------------------
  - Database: HOLLY_DB (with STRUCTURED, SEMI_STRUCTURED, UNSTRUCTURED schemas)
...
INSERT INTO HOLLY_DB.STRUCTURED.SP500_COMPANIES (SYMBOL, COMPANY_NAME, SECTOR, INDUSTRY, HEADQUARTERS, DATE_ADDED, CIK, FOUNDED)
SELECT * FROM VALUES
