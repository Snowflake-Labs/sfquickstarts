...
language: en
summary: Build an AI-powered quantitative research pipeline using CoCo, Cortex AI Functions, ML Model Registry, and Snowflake Intelligence to transform earnings call transcripts into actionable investment insights.
...
- Build and deploy predictive Machine Learning (ML) models in minutes with the conversational power of CoCo.
...
The architecture shows how CoCo serves as the central AI coding assistant throughout the pipeline—from data ingestion using **Snowflake Public Data (Free)** from Snowflake Marketplace, to sentiment extraction with Cortex AI Functions, ML model training and registry, and finally the unified agent experience in Snowflake Intelligence.
...
**What makes this guide unique:** Rather than just running pre-built notebooks, you can use CoCo to build the entire ML pipeline through conversation—from feature engineering to model training, backtesting, and registration in the Snowflake ML Registry.
...
### CoCo
- [Snowflake Unveils CoCo](https://www.snowflake.com/en/news/press-releases/snowflake-unveils-cortex-code-an-ai-coding-agent-that-drastically-increases-productivity-by-understanding-your-enterprise-data-context/)
