...
Under **Admin**, the **​Warehouses​** tab is where you set up and manage compute resources known as virtual warehouses to load or query data in Snowflake. A warehouse called COMPUTE_WH already exists in your environment.  [Click here](https://app.snowflake.com/_deeplink/#/compute/warehouses?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-getting-started-with-snowflake&utm_cta=developer-guides-deeplink) to go directly to the Warehouses tab.
...
Navigate to the [**Databases** tab](https://app.snowflake.com/_deeplink/#/data/databases?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-getting-started-with-snowflake&utm_cta=developer-guides-deeplink). Click **Create**, name the database `Public_Data`, then click **CREATE**.

![worksheet creation](assets/Create_New_DB.png)

Now navigate to the [**Worksheets** tab](https://app.snowflake.com/_deeplink/worksheets?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-getting-started-with-snowflake&utm_cta=developer-guides-deeplink). You should see the worksheet we created in step 3.
...
Navigate to the [**Warehouses** tab](https://app.snowflake.com/_deeplink/#/compute/warehouses?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-getting-started-with-snowflake&utm_cta=developer-guides-deeplink) (under **Admin**). This is where you can view all of your existing warehouses, as well as analyze their usage trends.
...
Make sure you're using the `ACCOUNTADMIN` role and, [navigate to the Marketplace](https://app.snowflake.com/_deeplink/marketplace?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-getting-started-with-snowflake&utm_cta=developer-guides-deeplink) (**Data Products** > **Marketplace**):
...
The [**Cost Management** tab](https://app.snowflake.com/_deeplink/#/account/usage?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=getting-started-with-snowflake&utm_cta=developer-guides-deeplink) shows your usage of Snowflake credits, with filters by account and consumption types:
