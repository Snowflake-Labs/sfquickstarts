...
![img](assets/sf_i4-databases.png)
...
![img](assets/sf_i5-worksheets.png)
...
![img](assets/sf_i7-worksheet-rename.png)
...
![img](assets/sf_i8-query-history.png)
...
![img](assets/sf_i9-profile-accountadmin.png)
...
![img](assets/sf_9-partner-connect-connect.png)
...
![4](assets/sf_4-query-education.png)

```sql
select * from RAW.JOB_POSTINGS limit 10;
```

![5](assets/sf_5-query-postings.png)
...
```
![6](assets/sf_6-query-postings-enriched.png)
