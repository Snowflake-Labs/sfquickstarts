...
In this guide, you'll learn how to build a complete machine learning workflow entirely within Snowflake. You'll work through a mortgage lending prediction use case, implementing each stage of the ML lifecycle from feature engineering to model deployment and monitoring.

This tutorial showcases Snowflake's ML capabilities, including:
- Feature Store for tracking engineered features
...
- Model monitoring for tracking performance and drift

### What You'll Learn
- How to use Snowflake Feature Store to track engineered features
- How to train and optimize ML models using Snowflake ML APIs
- How to register and manage models in Snowflake Model Registry
- How to set up model monitoring to track performance metrics and detect drift
- How to track data and model lineage throughout the ML lifecycle
...
Firstly, to follow along with this quickstart, you can click on [train_deploy_monitor_ML_in_snowflake.ipynb](https://github.com/dataprofessor/e2e_ML_in_Snowflake/blob/main/train_deploy_monitor_ML_in_snowflake.ipynb) to download the Notebook from GitHub.
