...
### Prerequisites
- Access to Snowflake's Native Apps on marketplace. If you do not have a Snowflake account, you can register for a [free trial account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_). You may need to contact Snowflake Support to enable this for a trial account.
