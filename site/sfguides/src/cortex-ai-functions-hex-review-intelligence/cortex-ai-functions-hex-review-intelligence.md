...
categories: snowflake-site:taxonomy/solution-center/certification/quickstart, snowflake-site:taxonomy/product/ai, snowflake-site:taxonomy/snowflake-feature/cortex-llm-functions, snowflake-site:taxonomy/snowflake-feature/external-collaboration
environments: web
status: Published
...
2. Select your Snowflake connection (or [create one](https://learn.hex.tech/docs/connect-to-data/data-connections/setup-guides/connect-to-snowflake))
...
- [Hex Documentation — Connecting to Snowflake](https://learn.hex.tech/docs/connect-to-data/data-connections/setup-guides/connect-to-snowflake)
