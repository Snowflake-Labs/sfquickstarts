...
**Snowflake Account** with `ACCOUNTADMIN` role for managing permissions.
...
GRANT IMPORTED PRIVILEGES ON DATABASE OVERTURE_MAPS__DIVISIONS TO application DEKART__WEBGL_MAPS_FOR_SNOWFLAKE;
...
### Calculate Charging Station Density Near Roads
