...
### Prerequisites
- A non-trial Snowflake [Snowflake](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides)  account in a supported AWS commercial region.
