...
- **OpenAI:** Provide an API token from your OpenAI organization. [Learn how to get an API token](https://help.openai.com/en/articles/). 
- **Slack:** Allow connections to the slack.com domain for sending AI Agent insights to your selected Slack rooms.
...
![Select the dates](assets/agent_step_5.png)
