...
- [Quickstart: Getting Started with Cortex Agents](https://www.snowflake.com/en/developers/guides/getting-started-with-cortex-agents/)
- [Quickstart: Getting Started with Snowflake Cortex Agents API and React](https://www.snowflake.com/en/developers/guides/getting-started-with-snowflake-agents-api-and-react/)
