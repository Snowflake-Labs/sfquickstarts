...
<!---------------------------->
## Configuring Kafka Connector with Apache Iceberg tables
Duration: 20
...
To configure the Kafka connector for Iceberg table ingestion,follow the regular setup steps for a Snowpipe Streaming-based connector mentioned in the Step 4 of this tutorial with a few differences noted in the following sections.
...
To create an external volume in S3, configure the prerequisites mentioned in this document
https://docs.snowflake.com/en/user-guide/tables-iceberg-configure-external-volume-s3?_fsi=jKSUJNzH&_fsi=jKSUJNzH
...
#### 2.Pre-Create an Snowflake-managed Iceberg Table for Streaming
