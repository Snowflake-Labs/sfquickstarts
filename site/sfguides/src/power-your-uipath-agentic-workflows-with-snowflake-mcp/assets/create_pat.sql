...
-- =============================================================================
-- A PAT allows external applications (like UiPath Orchestrator) to authenticate
...
ALTER USER <YOUR_USERNAME> ADD PROGRAMMATIC ACCESS TOKEN
  TOKEN_NAME = 'uipath_mcp_token'
  COMMENT = 'PAT for UiPath Orchestrator MCP integration'
...
-- Store it securely — you will need it when configuring the UiPath MCP connection.
--
-- If you lose the token, you must drop and recreate it:
--   ALTER USER <YOUR_USERNAME> DROP PROGRAMMATIC ACCESS TOKEN TOKEN_NAME = 'uipath_mcp_token';
