...
- A [Snowflake Enterprise or Business Critical Account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_) with **ACCOUNTADMIN** access or setup assistance
...
### Resources
- [Download Reference Architecture](/content/dam/snowflake-site/developers/2024/07/Industrial-IoT_-Snowpipe-Streaming_Reference-Architecture.pdf)
- [Read the Blog](/blog/manufacturing-data-ingestion-into-snowflake/)
