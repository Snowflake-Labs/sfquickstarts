...
1. Sign in to Snowsight and navigate to [**Projects** → **Workspaces**](https://app.snowflake.com/_deeplink/#/workspaces?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=getting-started-with-openflow-unstructured-data-pipeline&utm_cta=developer-guides-deeplink)
...
> **IMPORTANT:** You still need to **clone or download the repository locally** to access the `sample-data/google-drive-docs/` files for uploading to Google Drive. The Git integration in [Workspaces](https://app.snowflake.com/_deeplink/#/workspaces?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=getting-started-with-openflow-unstructured-data-pipeline&utm_cta=developer-guides-deeplink) provides access to SQL scripts but not binary document files (PDF, DOCX, PPTX, JPG) needed for the demo.
...
3. Navigate directly to Agents: [Create Snowflake Intelligence Agent](https://app.snowflake.com/_deeplink/#/agents?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_campaign=-us-en-all&utm_content=app-buidling-new-snowflake-intelligence-agents&utm_cta=developer-guides-deeplink)
