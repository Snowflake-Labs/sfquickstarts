...
st.set_page_config(page_title="Data Explorer", page_icon=":material/bar_chart:", layout="wide")
...
if uploaded_file is not None:
    ...
    st.info(":material/arrow_left: Please upload a CSV file using the sidebar to begin.")
