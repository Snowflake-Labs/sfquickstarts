...
id: tasty_bytes_introduction_v2
...
- Click on the Projects Tab in the left-hand navigation bar then click Workspaces.

### Step 4 - Creating a Worksheet
- Within Workspaces, click the "+ Add New" button in the top-right corner of Snowsight to create a new SQL Worksheet.
