...
CREATE OR REPLACE chatbot_db;
CREATE OR REPLACE chatbot_schema;
```
...
You built a RAG chatbot that allows you to chat with the Snowflake Documentation in natural language. It uses a Cortex Knowledge Extension, Snowflake Cortex AI's **COMPLETE** function, and Streamlit in Snowflake.
