...
Save the json from the output of this script for the next step
...
Open the profile.json in the editor and paste in the json configuration generated by the sql script in the previous step.
