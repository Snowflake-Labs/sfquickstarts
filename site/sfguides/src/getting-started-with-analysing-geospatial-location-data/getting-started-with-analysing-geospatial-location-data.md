...
# Getting Started with Analysing Geospatial Location Data
<!-- ------------------------ -->
## Overview
Duration: 10
...
- An use case investigation on how you can call an Api to get the latest flood warnings and how flood risk zones impact the buildings which were loaded in the previous use case.
...
CREATE DATABASE IF NOT EXISTS LOCATION_ANALYTICS;
