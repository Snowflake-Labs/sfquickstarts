...
id: tasty-bytes-zero-to-snowflake-collaboration-ja
...
[Snowflakeマーケットプレイス](/ja/data-cloud/marketplace/)を活用してすぐに調査できるアイデアの1つは、異常気象と、Weather Sourceが提供している無料の公開リストです。
