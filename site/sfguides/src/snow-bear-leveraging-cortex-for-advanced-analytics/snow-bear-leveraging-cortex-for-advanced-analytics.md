...
**To use Workspaces:**
1. In Snowsight, click `Projects`, then [Workspaces](https://app.snowflake.com/_deeplink/#/workspaces?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=snow-bear-leveraging-cortex-for-advanced-analytics&utm_cta=developer-guides-deeplink) in the left navigation
2. Click `+ Add new` to create a new [Workspace](https://app.snowflake.com/_deeplink/#/workspaces?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=snow-bear-leveraging-cortex-for-advanced-analytics&utm_cta=developer-guides-deeplink)
