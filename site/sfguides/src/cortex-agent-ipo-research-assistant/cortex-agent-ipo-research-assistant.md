...
Use [this](https://github.com/Snowflake-Labs/sfquickstarts/blob/master/site/sfguides/src/cortex-agent-ipo-research-assistant/Finnhub%20Integration%20Setup.ipynb) link to download the notebook.
