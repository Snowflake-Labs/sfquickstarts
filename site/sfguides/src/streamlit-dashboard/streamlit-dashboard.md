...
### Prerequisites
- Access to a Snowflake account (sign up for a [free trial account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides)) with permissions to use Snowflake Notebooks
