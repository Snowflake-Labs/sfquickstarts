...
id: building-dynamic-tables-in-snowflake-with-coalesce
...
### What You’ll Need 
- A Snowflake account [trial account](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_) or access to an existing account with `ACCOUNT ADMIN` privileges 
...
1. Fill out the Snowflake trial account form [here](https://signup.snowflake.com/?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_cta=quickstarts_). Use an email address that is not associated with an existing Snowflake account. 
