...
- **authors**: Chandra Nayak , Bailey Ferrari (Belongs to Ferrari Family)
...
<!-- ------------------------ -->
<!-- ------------------------ -->
## Weather Data from Data Marketplace
...
```
### Is Weather in NYC good for Cycling 
```
...
Let's get Geospatial data to locate the stations from where citibike's are picked
...
### Combine Station_id with Geospatial Data
``` 
